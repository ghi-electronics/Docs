...
## Overview
Our UC5550 modules are a step up from the UC2550 in terms of processor speed, internal flash, external RAM and available peripherals.  Unlike the UC2550, the UC5550s have USB host, parallel LCD, DCMI interfaces and Ethernet PHY support.
