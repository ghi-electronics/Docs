# MicroPython
---
![MicroPython Logo](images/micro-python-logo-noborder.png)
...
This video shows the steps needed to use MicroPython on the FEZ (The FEZ and the BrainPad share the same processor).
