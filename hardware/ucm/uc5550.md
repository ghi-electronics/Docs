...
We currently stock the UC5550 both with and without WiFi depending on the model. The current models are shipping with 16MB of external RAM and 4MB of external flash. We also offer customized, non-stock versions of our SoMs. See [Options](#options) below for suggested customization options, or [contact us](http://ghielectronics.com/company/contact) to request additional customization. 
...
## Options
| Model Number | WiFi | Ethernet PHY | External 16MB RAM | External 4MB Flash | 
|--------------|------|-------------|--------------------|-------------------|
| UC5550-67HFN | no   | no | yes | yes |
| UC5550-67HFW | yes  | no | yes | yes |
| UC5550-XXXXX custom (non-stock) | (custom) | (custom) | (custom) | (custom) |
