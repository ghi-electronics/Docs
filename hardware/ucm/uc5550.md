...
Download the UC5550 bootloader [here](../../software/loaders/ghi-bootloader.md#uc5550).

Go to the [Uploading DFU Files](../../software/loaders/stm32-bootloader.md#uploading-dfu-files) section of the [STM32 Bootloader](../../software/loaders/stm32-bootloader.md) page for instructions on installing the bootloader.
...
Download the [UC5550 firmware](../../software/tinyclr/downloads.md#uc5550) and follow [Loading the Firmware](../../software/loaders/ghi-bootloader.md#loading-the-firmware) steps.
...
TinyCLR cannot relocate native code, so you will have specify its location in the scatterfile. For the UC5550, the interop region starts at address 0xC1F00000, and its length is 0xFFFF8.
...
The following CAN bit timing paramaters were calculated for a UC5550 driving the SN65HVD230 CAN driver chip. See the [Configuring the Bus](../../software/tinyclr/tutorials/can.md#configuring-the-bus) section of the [CAN Tutorial](../../software/tinyclr/tutorials/can.md) for more information.
