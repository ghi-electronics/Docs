...
TinyCLR cannot relocate native code, so you will have specify its location in the scatterfile. For the G400D, the interop region starts at address 0x26700000, and its length is 0x16FFFF8.
...
|---|---|---|---|---|---|---|---|---|---
| 33.333K | 8 | 3 | 2 | 286 | 2 | False | 85.7% | 0.56% | 1685M
