...
Download the UC2550 bootloader [here](../../software/tinyclr/loaders/ghi_bootloader.md#uc2550).
...
To activate bootloader v2, hold the LDR0 signal low (press SYS B on UCM Dev and Breakout boards) while resetting the board.

Download the [UC2550 firmware](../../software/tinyclr/downloads.md) and follow [Loading the Firmware](../../software/tinyclr/loaders/ghi_bootloader.md#loading-the-firmware) steps.
