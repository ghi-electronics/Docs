...
Download the UC2550 bootloader from [here](../../software/loaders/ghi-bootloader.md#uc2550).
...
Download the [UC2550 firmware](../../software/tinyclr/downloads.md#uc2550) and follow the [Loading the Firmware](../../software/loaders/ghi-bootloader.md#loading-the-firmware) steps.
...
The following CAN bit timing paramaters were calculated for a UC2550 driving the SN65HVD230 CAN driver chip. See the [Configuring the Bus](../../software/tinyclr/tutorials/can.md#configuring-the-bus) section of the [CAN Tutorial](../../software/tinyclr/tutorials/can.md) for more information.
