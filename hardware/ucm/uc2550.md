...
It does have 1 MB of internal flash memory and can be ordered with onboard WiFi as well. We also offer customized, non-stock versions of our SoMs. See [Options](#options) below for suggested customization options, or [contact us](http://ghielectronics.com/company/contact) to request additional customization.
...
## Options
| Model Number | WiFi PHY | External 4MB Flash | 
|--------------|------|--------------------|
| UC2550-13NNN | no   | no |
| UC2550-13NNW | yes  | no |
| UC2550-XXXXX custom (non-stock) | (custom) | yes (custom) |
