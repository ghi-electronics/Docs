...
There are several options available for programming the UC2550 which are described below.
...
Go to the [SAMBA](../../software/tinyclr/loaders/intro.md#sam-ba-bootloader) section of the [Bootloaders Introduction](../../software/tinyclr/loaders/intro.md) page for instructions.
