...
It does have 1 MByte of internal flash memory and can be ordered with onboard Wi-Fi as well. We also offer customized, non-stock versions of our SoMs. See [Options](#options) below for more information.
