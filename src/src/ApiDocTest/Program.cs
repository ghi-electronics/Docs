namespace GHIElectronics.TinyCLR.Devices.Gpio.Provider {
    ...
    public sealed class GpioPinProviderValueChangedEventArgs {
        public ProviderGpioPinEdge m_edge;

        public GpioPinProviderValueChangedEventArgs(ProviderGpioPinEdge edge) => this.m_edge = edge;
    ...
    public class GpioProvider : IGpioProvider {
        public IGpioControllerProvider[] controllers;

        public string Name { get; }

        public IGpioControllerProvider[] GetControllers() => this.controllers;

        public GpioProvider(string name) {
    ...
    public class DefaultGpioControllerProvider : IGpioControllerProvider {
...
#pragma warning restore CS0649
        ...
        public DefaultGpioControllerProvider(string name, uint index, Api api) {
            this.Name = name;
            this.Index = index;
    ...
    public sealed class DefaultGpioPinProvider : IGpioPinProvider {
        public object m_syncLock = new object();
        public bool m_disposed = false;
        public int m_pinNumber = -1;

        public ProviderGpioPinDriveMode m_driveMode = ProviderGpioPinDriveMode.Input;
        public ProviderGpioPinValue m_lastOutputValue = ProviderGpioPinValue.Low;
        public GpioPinProviderValueChangedEventHandler m_callbacks = null;
        public readonly IntPtr nativeProvider;
        public readonly DefaultGpioControllerProvider parent;

        public DefaultGpioPinProvider(DefaultGpioControllerProvider parent, IntPtr provider) {
        ...
        public bool Init(int pinNumber) {
        ...
        /// <summary>
        /// Handles public events and re-dispatches them to the publicly subsribed delegates.
        /// </summary>
        /// <param name="edge">The state transition for this event.</param>
        public void OnPinChangedInternal(ProviderGpioPinEdge edge) {
        ...
        /// <returns>True if the pin was found and reserved; otherwise false.</returns>
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        extern public bool InitNative(int pinNumber);

        /// <summary>
        /// Release the interop components of the pin.
        /// </summary>
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        extern public void DisposeNative();
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        extern public void SetDriveModeInternal(ProviderGpioPinDriveMode driveMode);

        /// <summary>
        /// Releases public resources held by the GPIO pin.
        /// </summary>
