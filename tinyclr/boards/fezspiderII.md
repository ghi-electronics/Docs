...
16. `Now you can transfer the firmware file, just like you transferred the bootloader before. Go to File->Transfer->XMODEM->Send… and then checkbox the 1K option.`
