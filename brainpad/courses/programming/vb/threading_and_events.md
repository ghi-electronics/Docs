...
```vb
AreAll4ButtonsPressed() As Boolean
Add() As Integer
```
Poorly named Functions
```vb
areallbuttonspressed() As Boolean
function34from94handler() As Integer
```
Invalid Function Names
```
Are All Buttons Pressed() As Boolean
AreAllButtonsPressed?() As Boolean
```
...
ActivateAlarm()
```
Finally, functions can also be private or public and static or non-static. This is beyond the scope of this course and `public static` will always be used.
